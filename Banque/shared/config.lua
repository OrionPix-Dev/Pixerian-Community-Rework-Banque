...
_Banque = {
    ...
    ["Translations"] = {
        ["Menu"] = {
            ...
            ["HelpNotif"] = "Appuyez sur ~INPUT_CONTEXT~ pour accéder à la ~HC_18~Banque ~BLIP_financier_strand~ ~s~+ ajouter qtarget",
...
_Banque.ServerTextColor = "HC_18"
_Banque.MarkerRGB = { r = 40, g = 80, b = 100, a1 = 250, a2 = 100 }
